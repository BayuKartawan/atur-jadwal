...
<template>
  ...
  >
    <div v-if="show" class="fixed inset-0 bg-slate-900/60 dark:bg-black/70 backdrop-blur-sm z-[60] flex items-center justify-center p-4">
      <div class="bg-white dark:bg-slate-900 rounded-3xl shadow-2xl w-full max-w-sm overflow-hidden border border-slate-100 dark:border-slate-800 transition-all duration-300">
        <div class="p-8 text-center sm:text-left">
          <div class="mb-4 inline-flex items-center justify-center w-12 h-12 rounded-full bg-indigo-50 dark:bg-indigo-950 text-indigo-500 sm:mx-0">
            <AlertCircle :size="24" />
          </div>
        ...
        <div class="bg-slate-50 dark:bg-slate-800/50 px-6 py-4 flex flex-col sm:flex-row gap-3">
