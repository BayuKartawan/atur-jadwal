...
<template>
  <div
    class="flex-1 overflow-auto bg-slate-50 dark:bg-slate-950 custom-scrollbar transition-colors duration-300"
  >
    <div
        ...
        <template v-for="(timeData, pIdx) in PERIOD_TIMES" :key="pIdx">
          ...
          >
            ...
            >
              ...
              />
              <span
                class="text-[7px] lg:text-[8px] font-black text-amber-500 dark:text-amber-600"
              >
                {{ timeData.time }}
              </span>
            </div>
          ...
          >
            ...
            >
              <span
                class="text-[8px] lg:text-[9px] font-black text-slate-300 dark:text-slate-600"
                >#{{ pIdx + 1 }}</span
              >
              <span
                class="text-[9px] lg:text-[10px] font-black text-slate-600 dark:text-slate-400 mt-0.5"
                >{{
            ...
            >
              ...
              >
                ...
                <span
                  class="text-[7px] lg:text-[8px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest text-white"
                  >OFF</span
                >
              </div>
              ...
              <div
                v-else
                class="text-[7px] lg:text-[8px] font-black uppercase tracking-widest transition-all transform"
                :class="[
                  isDisableMode
                    ? 'text-rose-500'
                    : showEmptyCells
