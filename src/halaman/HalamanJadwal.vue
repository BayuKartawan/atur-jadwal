<script setup>
import { ref } from "vue";
import TaskSidebar from "../komponen/penjadwalan/SidebarTugas.vue";
import ScheduleGrid from "../komponen/penjadwalan/GridJadwal.vue";
...
<template>
  <div class="flex flex-col lg:flex-row h-full overflow-hidden relative">
    ...
    <button
      @click="toggleSidebar"
      class="lg:hidden fixed bottom-6 right-6 z-50 p-3 bg-indigo-600 text-white rounded-full hover:bg-indigo-700 flex items-center justify-center"
    >
    ...
    <div
      ...
      class="lg:hidden fixed inset-0 bg-slate-900/60 z-10"
    ></div>
  </div>
</template>
