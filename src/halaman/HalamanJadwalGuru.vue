    ...
    >
      ...
      >
        ...
        <div class="flex items-center gap-3 lg:gap-6">
          <div
            class="w-10 h-10 lg:w-12 lg:h-12 rounded-2xl bg-gradient-to-br from-cyan-500 to-blue-600 flex items-center justify-center text-white shrink-0"
          >
          ...
          <div>
            ...
            >
              <span
                class="w-1.5 h-1.5 rounded-full bg-cyan-500"
              ></span>
              Detail Jadwal Mapel
            </p>
          </div>
        ...
        <div class="flex items-center gap-2 lg:gap-3 w-full sm:w-auto">
          ...
          <AppButton
            ...
            variant="primary"
            class="!rounded-xl !py-2.5 !h-[42px] lg:!h-auto !px-4 !bg-cyan-600 hover:!bg-cyan-700 disabled:shadow-none disabled:!bg-slate-100 dark:disabled:!bg-slate-800 disabled:!text-slate-400 shrink-0"
          >
            <template #icon-left>
              <Printer :size="16" />
            </template>
        ...
        >
          ...
          <div class="divide-y divide-slate-50 dark:divide-slate-800/50">
            <div
              ...
              :key="pIdx"
              class="px-4 py-3 flex items-start gap-3 hover:bg-slate-50 dark:hover:bg-slate-800/30"
            >
              <div
              ...
              <div class="flex-1 min-w-0">
                <div v-if="period.isBreak" class="h-full flex items-center">
                  <span
                    class="px-2 py-0.5 rounded text-[9px] font-semibold uppercase tracking-widest bg-amber-50 dark:bg-amber-900/20 text-amber-600 dark:text-amber-400"
                  >
                    Istirahat
                  </span>
                </div>
    ...
    >
      ...
      >
        ...
        <div class="flex items-center gap-3">
          <button
            @click="handlePrint"
            class="bg-cyan-600 hover:bg-cyan-500 text-white px-6 py-2 rounded-xl text-[10px] font-semibold uppercase tracking-widest"
          >
            Cetak Sekarang
          </button>
          <button
                ...
                <template v-for="(cell, cIdx) in row.cells" :key="cIdx">
                  ...
                  >
                    ...
                    >
                      ...
                      <div
                        class="text-[8px] font-semibold border-t border-black/10 pt-1 mt-auto"
                      >
                        KELAS {{ cell.classId }}
                      </div>
                    </div>
