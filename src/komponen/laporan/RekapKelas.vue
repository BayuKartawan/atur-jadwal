...
<template>
    <div
        class="p-4 lg:p-8 pt-0 lg:pt-0 flex flex-col h-full bg-slate-50/50 dark:bg-slate-950/50">
        <div
            class="bg-white dark:bg-slate-900 rounded-2xl lg:rounded-[2rem] border border-slate-100 dark:border-slate-800 flex flex-col h-full">
            ...
            <div
                ...
                <div class="flex items-center gap-4 lg:gap-6">
                    <div
                        class="w-10 h-10 lg:w-12 lg:h-12 rounded-2xl bg-gradient-to-br from-pink-500 to-rose-600 flex items-center justify-center text-white shrink-0">
                        <Users :size="20" class="lg:hidden" />
                    ...
                    <div class="ml-auto">
                        <AppButton @click="downloadClassRecap" variant="primary"
                            class="!rounded-xl !py-2.5 !px-4 !bg-pink-600 hover:!bg-pink-700">
                            <template #icon-left>
                                <Download :size="16" />
                            </template>
            ...
            <div class="flex-1 overflow-y-auto custom-scrollbar p-4 lg:p-8">
                <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                    <div v-for="cls in classRecaps" :key="cls.name"
                        class="bg-slate-50 dark:bg-slate-800/50 rounded-2xl border border-slate-200 dark:border-slate-700/50 overflow-hidden flex flex-col h-full hover:shadow-lg hover:-translate-y-1">
                        ...
                        <div
                            ...
                            <h4 class="font-semibold text-slate-800 dark:text-slate-200 text-lg">KELAS {{ cls.name }}</h4>
                            <span
                            ...
                            <table class="w-full text-left text-sm">
                                ...
                                <tbody class="divide-y divide-slate-100 dark:divide-slate-700/50">
                                    <tr v-for="teacher in cls.teachers" :key="teacher.id"
                                        class="hover:bg-white dark:hover:bg-slate-700/50">
