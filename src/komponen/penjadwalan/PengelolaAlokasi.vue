    ...
    <AppCard class="mb-8" overflowVisible>
      <div class="grid grid-cols-2 md:grid-cols-12 gap-4 lg:gap-6 items-end">
        ...
        <div class="col-span-1 md:col-span-1 flex flex-col gap-1.5">
          <label
            class="text-[10px] font-semibold text-slate-400 dark:text-slate-500 uppercase tracking-widest text-center"
            >JTM</label
          >
          <div
            class="w-full bg-slate-100 dark:bg-slate-800 p-3 rounded-2xl text-sm text-center font-semibold text-slate-600 dark:text-slate-400 border border-slate-200 dark:border-slate-700"
          >
            {{ allocForm.jtm }}
          </div>
        </div>
        <div class="col-span-2 md:col-span-2 flex gap-2">
          <button
            ...
            type="button"
            class="h-[52px] w-[52px] rounded-2xl bg-rose-100 dark:bg-rose-900/30 text-rose-600 dark:text-rose-400 hover:bg-rose-200 dark:hover:bg-rose-900/50 flex items-center justify-center shrink-0"
            title="Batal Edit"
          >
          ...
          <AppButton
            ...
            class="w-full !h-[52px] !rounded-2xl !text-white group disabled:!bg-slate-200 dark:disabled:!bg-slate-800 disabled:!text-slate-400 flex items-center justify-center"
            :class="
              isEditing
                ? '!bg-amber-500 hover:!bg-amber-600 dark:shadow-amber-900/40'
                : '!bg-emerald-600 dark:!bg-emerald-500 hover:!bg-emerald-700 dark:hover:!bg-emerald-400 dark:shadow-emerald-900/40'
            "
            :disabled="
              !allocForm.teacherId ||
              !allocForm.subjectId ||
          ...
          >
            ...
            <span class="font-semibold uppercase tracking-widest text-[11px]">{{
      ...
      >
        <div class="flex items-center gap-4 shrink-0">
          ...
          >
            ...
            <Filter :size="32" class="hidden lg:block" />
          </div>
          <div>
            <h3
            ...
            <p class="text-xs lg:text-sm font-medium text-slate-500 dark:text-slate-400 mt-1">
              Kelola dan saring beban alokasi jam mengajar guru
            </p>
          </div>
        </div>
        ...
        >
          ...
          <div class="flex items-center gap-2 w-full xl:w-80">
            <div class="relative flex-1 group">
              ...
              <input
                ...
                class="w-full pl-10 pr-8 py-2.5 bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-2xl text-xs font-bold text-slate-700 dark:text-slate-200 outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 placeholder:text-slate-400"
              />
              <button
                v-if="searchQuery"
                @click="searchQuery = ''"
                class="absolute right-2 top-1/2 -translate-y-1/2 w-6 h-6 rounded-full flex items-center justify-center text-slate-400 hover:text-rose-500 hover:bg-rose-50 dark:hover:bg-rose-900/30"
              >
          ...
          <div class="flex items-center gap-2 w-full xl:w-auto">
            <div
              class="flex flex-row items-center gap-1.5 p-1 bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 flex-1 xl:flex-none"
            >
              <AppSelect
      ...
      >
        ...
        >
          <div
            ...
            :key="a.id"
            class="bg-white dark:bg-slate-900 rounded-[1.5rem] border border-slate-100 dark:border-slate-800 p-4 hover:shadow-xl hover:shadow-indigo-500/10 flex flex-col h-auto relative group"
          >
            ...
            <div class="flex items-start justify-between mb-3">
              ...
              >
                <div
                  class="w-6 h-6 rounded-lg bg-emerald-500 text-white flex items-center justify-center text-[10px] font-semibold"
                >
                  {{ a.classId }}
                </div>
                <span
              ...
              <div class="flex items-center gap-1">
                <button
                  @click="$emit('edit', a)"
                  class="w-8 h-8 rounded-xl bg-amber-50 dark:bg-amber-900/20 text-amber-600 dark:text-amber-400 hover:bg-amber-100 dark:hover:bg-amber-900/40 flex items-center justify-center"
                  title="Edit"
                >
                ...
                <button
                  ...
                  class="w-8 h-8 rounded-xl bg-rose-50 dark:bg-rose-900/20 text-rose-600 dark:text-rose-400 hover:bg-rose-100 dark:hover:bg-rose-900/40 flex items-center justify-center"
                  title="Hapus"
                >
            ...
            <div class="flex-1 space-y-2 mb-4">
              <h3
                class="text-sm lg:text-base font-semibold text-slate-800 dark:text-slate-100 leading-snug line-clamp-2"
              ...
              <div class="flex items-center gap-2">
                ...
                <div>
                  <h4
                    class="text-[9px] font-semibold text-slate-400 dark:text-slate-500 uppercase tracking-wider"
                  >
                    Guru Pengampu
                  </h4>
                  <p
            ...
            >
              <div class="flex items-center gap-2">
                <div
                  class="px-2 py-1 rounded-lg bg-indigo-50 dark:bg-indigo-900/20 text-indigo-600 dark:text-indigo-400 text-[10px] font-semibold tracking-wide border border-indigo-100 dark:border-indigo-800/30"
                >
                  {{ a.jtm }} JTM
                </div>
              </div>
