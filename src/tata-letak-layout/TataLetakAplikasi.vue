...
// Components
import AppModal from "../komponen/umum/ModalAplikasi.vue";
import AppNotification from "../komponen/umum/NotifikasiAplikasi.vue";
import AppHeader from "../komponen/tata-letak/HeaderAplikasi.vue";
import AppSidebar from "../komponen/tata-letak/SidebarAplikasi.vue";

import ScrollToTop from "../komponen/ui/GulirKeAtas.vue";
...
<template>
  <div
    class="h-screen flex flex-col lg:flex-row bg-white dark:bg-slate-950 font-sans text-slate-900 dark:text-slate-100 overflow-hidden"
  >
    <!-- Sidebar -->
    ...
    <div
      ...
      class="fixed bottom-1 left-1 right-25 lg:bottom-12 lg:left-1/2 lg:right-auto lg:w-auto lg:-translate-x-1/2 bg-slate-900 dark:bg-slate-800 border border-white/10 rounded-2xl lg:rounded-3xl px-5 py-3 lg:px-8 lg:py-5 z-40 flex items-center justify-between lg:justify-start gap-3 lg:gap-6 border-b-4 border-b-indigo-500"
    >
      <div class="flex flex-col min-w-0">
        <span
          class="text-[8px] lg:text-[9px] font-semibold text-indigo-400 uppercase tracking-widest lg:tracking-[0.2em] mb-0.5 lg:mb-1 italic"
          >Menyusun Jadwal:</span
        >
        <div
          class="text-xs lg:text-sm font-medium text-white tracking-tight truncate flex items-center"
        >
      ...
      <button
        ...
        class="shrink-0 p-2 lg:p-2.5 bg-white/10 hover:bg-rose-500 text-white/50 hover:text-white rounded-xl lg:rounded-2xl"
      >
